...
if __name__ == "__main__":
    ...
    IMG_DIR = r"F:/ultralytics/datasets/add/images"
    XML_DIR = r"F:/ultralytics/datasets/add/xml"

    # 存储增强后的影像文件夹路径
    AUG_IMG_DIR = r"F:/ultralytics/datasets/data/images"
    mkdir(AUG_IMG_DIR)
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = r"F:/ultralytics/datasets/data/labels"
    mkdir(AUG_XML_DIR)
