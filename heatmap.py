...
def get_params():
    params = {
        'weight': 'F:/ultralytics/runs/train/GDA-DETR(EIOU)/weights/best.pt',
        'cfg': 'F:/ultralytics/ultralytics/cfg/models/rt-detr/rtdetr-l-gda.yaml',
        'device': 'cuda:0',
        'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM
        'layer': 'model.model[12]',
        'backward_type': 'all',  # class, box, all
        'conf_threshold': 0.8,  # 0.3
        'ratio': 0.5  # 0.5-1.0
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'F:\ultralytics\datasets\yolov8\valid\images\15_2048_1024_3328_2304.jpg', 'result')